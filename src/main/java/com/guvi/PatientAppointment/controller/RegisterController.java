...
import com.guvi.PatientAppointment.service.EmailService;
...
public class RegisterController {
    ...
    public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid @PathVariable User user, BindingResult bindingResult, HttpServletRequest request) {
